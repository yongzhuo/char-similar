...
from char_similar.version import __version__
...
# Package meta-data.
NAME = 'char-similar'
DESCRIPTION = 'char-similar: Tookit of Chinese Character Similarity, Especially the Shape of the Characters.'
...
setup(name=NAME,
        ...
        package_data={'char_similar': ['*.*', 'data/*']},
